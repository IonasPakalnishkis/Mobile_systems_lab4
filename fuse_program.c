...
#define STORE_FILE "/home/user/git/bsu/PMVS4/filesave"
#define BUF_FILE "/home/user/git/bsu/PMVS4/buffile"
struct file_info {
...
static int utimens_callback (const char *v, const struct timespec tv[2])
{
	return 0;
}
static int getxattr_callback (const char *x, const char *y, char *z, size_t f)
{
	return 0;
}
static int setxattr_callback (const char *x, const char *y, const char *z, size_t l, int f)
{
	return 0;
}
static int listxattr_callback (const char *x, char *y, size_t z)
{
	return 0;
}
...
static int truncate_callback (const char * z, off_t v)
{
	return 0;
}
